...
==========================================
Created by Bui Dinh Ngoc - Dec 2015
...
```{r}
setwd("C:/Users/NgocBD/Reproducible-Research-Assessment-2")

if (!"repdata-data-StormData.csv" %in% dir("./data/")) {
    
    download.file("http://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2", destfile = "data/repdata-data-StormData.csv.bz2")
